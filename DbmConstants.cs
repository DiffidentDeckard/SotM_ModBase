namespace DeckardBaseMod
{
    public static class DbmConstants
    {
        ...
        public const string HasUsedAbilityThisTurn = nameof(HasUsedAbilityThisTurn);
    }
    ...
    public static class TestHero3Constants
    {
        ...
        // Cards
        public const string TestHero3Target = nameof(TestHero3Target);
        public const string TestHero3Ongoing = nameof(TestHero3Ongoing);
        public const string TestHero3Equipment = nameof(TestHero3Equipment);
        public const string TestHero3OneShot = nameof(TestHero3OneShot);
    }
